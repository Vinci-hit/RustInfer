...
|------|-------------|-------------|
| Llama-3.2-1B-AWQ | 326 tok/s (1.74x vs BF16) | **912 tok/s** |
| Qwen3-4B-AWQ (MLP only) | 105 tok/s | 待调优 |

> **注意**: Qwen3-4B-AWQ 在 H20 上性能未达预期，需要针对 Hopper 架构调整 kernel launch 参数。Llama-3.2-1B-AWQ 在 H20 上已正常发挥（912 tok/s）。
