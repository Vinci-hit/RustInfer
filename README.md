...
> **测试环境**: H20, Batch Size=1, BF16, CUDA Graph enabled, vLLM compile disabled

### Qwen3-4B

| | RustInfer | vLLM |
|--|-----------|------|
| **Decode 吞吐量** | **276 tok/s** | 255 tok/s |
| **Decode TPOT** | **3.62ms** | 3.91ms |
...
| | RustInfer | vLLM |
|--|-----------|------|
| **Decode 吞吐量** | **800 tok/s** | — |

**v0.7.0 优化路径（259 → 276 tok/s, Qwen3-4B）**:
...
#### v0.7.0 (当前) - 手写GEMV + Kernel级优化，276 tok/s
**发布日期**: 2026-04
