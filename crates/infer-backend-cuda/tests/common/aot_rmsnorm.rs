...
const EPS: f32 = 1e-5;
// Exercise every compiled block specialization and both sides of boundaries.
const DIMENSIONS: &[usize] = &[
    1, 31, 32, 33, 37, 64, 65, 127, 128, 129, 256, 257, 511, 512, 513, 1024, 1025, 2048, 2049,
    4096, 4097, 8192, 8193, 16384,
];
...
#[test]
#[ignore = "requires a matching CUDA GPU and the selected AOT build toolchain"]
...
fn strided_layouts_and_oversized_rows_use_cuda_fallback() {
    ...
    // Beyond the AOT maximum block size, but valid for CUDA's vector widths.
