...
unsafe extern "C" {
    ...
    fn groupnorm_silu_f32_forward(output: *mut f32, input: *const f32, weight: *const f32, bias: *const f32,
        batch: i32, channels: i32, spatial: i32, num_groups: i32, eps: f32, stream: ffi::cudaStream_t);
    fn groupnorm_silu_bf16_forward(output: *mut half::bf16, input: *const half::bf16, weight: *const half::bf16,
        bias: *const half::bf16, batch: i32, channels: i32, spatial: i32, num_groups: i32, eps: f32, stream: ffi::cudaStream_t);
}
...
pub fn groupnorm_silu(
    ...
    match input.dtype() {
        ...
        other => Err(Error::InvalidArgument(format!(
            "CUDA groupnorm_silu: unsupported dtype {:?}", other
        )).into()),
    }
}
