...
pub fn add<T: Dtype>(
    ...
    unsafe {
        match T::DATA_TYPE {
            ...
            DataType::BF16 => add_kernel_bf16x8(
                dst.data_ptr_mut() as _,
                a.data_ptr() as _,
                b.data_ptr() as _,
                n,
            ...
            DataType::F16 => add_kernel_fp16x8(
                dst.data_ptr_mut() as _,
                a.data_ptr() as _,
                b.data_ptr() as _,
                n,
...
pub fn add_inplace<T: Dtype>(dst: &mut Tensor<T, Cuda>, src: &Tensor<T, Cuda>) -> OpResult<()> {
    ...
    unsafe {
        match T::DATA_TYPE {
            ...
            DataType::BF16 => {
                add_inplace_kernel_bf16x8(dst.data_ptr_mut() as _, src.data_ptr() as _, n, stream)
            }
            DataType::F16 => {
                add_inplace_kernel_fp16x8(dst.data_ptr_mut() as _, src.data_ptr() as _, n, stream)
            }
