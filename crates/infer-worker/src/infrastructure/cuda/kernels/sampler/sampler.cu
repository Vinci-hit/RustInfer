...
// ============================================================================
// (DELETED) argmax_batch_row_kernel and its wrappers — 1 block per row,
// 37x slower than two-phase for vocab=128k. The Rust layer now calls
// argmax_cu_*_ffi per row instead (126 blocks, ~5µs vs 184µs).
// ============================================================================
