...
///
/// `match_prefix` takes `&mut self` because the implementation maintains an
/// LRU clock and touches it on every match. This is intentional — single-
/// threaded engine ownership means no Mutex is needed.
