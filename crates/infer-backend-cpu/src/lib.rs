...
impl infer_core::ports::diffusion_ops::DiffusionOps for Cpu {
    fn conv2d<T: infer_core::dtype::Dtype>(
        ...
        <Self as infer_core::ports::DiffusionOps>::conv2d(
    ...
    fn groupnorm<T: infer_core::dtype::Dtype>(
        ...
        let _guard = infer_core::exec::ExecScope::enter(ctx.scope());
        <Self as infer_core::ports::DiffusionOps>::groupnorm(
    ...
    fn groupnorm_silu<T: infer_core::dtype::Dtype>(
        ...
        let _guard = infer_core::exec::ExecScope::enter(ctx.scope());
        <Self as infer_core::ports::DiffusionOps>::groupnorm_silu(
            input, weight, bias, output, num_groups, eps,
        )
    }
    ...
    fn layernorm<T: infer_core::dtype::Dtype>(
        ...
        let _guard = infer_core::exec::ExecScope::enter(ctx.scope());
        <Self as infer_core::ports::DiffusionOps>::layernorm(input, weight, bias, output, eps)
    }
    ...
    fn upsample_nearest_2x<T: infer_core::dtype::Dtype>(
        ...
        let _guard = infer_core::exec::ExecScope::enter(ctx.scope());
        <Self as infer_core::ports::DiffusionOps>::upsample_nearest_2x(input, output)
    }
    ...
    fn apply_rope_interleaved<T: infer_core::dtype::Dtype>(
        ...
        let _guard = infer_core::exec::ExecScope::enter(ctx.scope());
        <Self as infer_core::ports::DiffusionOps>::apply_rope_interleaved(x, cos, sin, head_dim)
    }
    ...
    fn tanh_inplace<T: infer_core::dtype::Dtype>(
        ...
        let _guard = infer_core::exec::ExecScope::enter(ctx.scope());
        <Self as infer_core::ports::DiffusionOps>::tanh_inplace(x)
    }
}
